...
const Design = () => (
  <>
    ...
    <p>在这里，你将能掌握这些创造工具——</p>
    <ul>
      <li>图像编辑 Adobe Photoshop</li>
      <li>矢量绘图 Adobe IIIustrator</li>
      <li>视频/建模Adobe After Effects、Cinema 4D</li>
      <li>常用UI设计 Sketch、Adobe XD</li>
    </ul>
    <p>在这里，你将有机会进行UI设计和平面设计，无限满足你对美的追求</p>
  </>
);
const Branch = () => {
