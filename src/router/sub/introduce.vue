...
export default {
  data () {
    return {
      ...
      introduce: '欢迎您参加星辰工作室2019年秋季招新答题，可根据您的意向选择方向进行答题。答题过程中可选择保存答卷以便退出后答卷丢失，完成答题后请务必提交答卷。本次答题时间为09.15—09.23 23:59(因之前遇到网络故障，故延长一天时间），请在规定时间内完成答题。答题结果将以短信形式通知。Good luck！'
    }
  },
  methods: {
    changeFlag () {
